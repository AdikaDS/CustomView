...
public class DialView extends View {
    ...
    // Butuh paint untuk gambar di kanvas.. Menyimpan gambar dan komponen
    private Paint mTextPaint;
    private Paint mDialPaint;

    // Radius untuk mendapatkan width dan height
    ...
    private void init() {
        ...
        setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Buat gambar ulang yang udah di draw
                invalidate();
            }
        });
    }
